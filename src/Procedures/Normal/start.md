...
3. Throttle—**IDLE** at 12–16% RPM. Check ignition indicator light is on, fuel flow is indicated, and confirm the fuel BOOST PUMP INOP light is extinguished.
...
4. Exhaust temperature—**CHECK**—Light-up should occur within 20 seconds after the throttle is moved to **IDLE**, indicated by rising exhaust gas temperature.
...
5. 40-45% RPM—**DISCONNECT AIR SUPPLY AND GROUND POWER**
...
6. Engine Idle—**CHECK ENGINE INSTRUMENTS**—confirm:
...
2. Throttle—**IDLE** at 2–4% RPM. Check ignition indicator light-on, fuel flow is indicated, and confirm the fuel BOOST PUMP INOP light is extinguished.

!!! warning
    If the fuel BOOST PUMP INOP light remains on, the DC boost pump has failed. Abort the flight.

3. Exhaust Gas Temperature—**CHECK**—Light-up should occur (as indicated by rising exhaust temperature) within 8–10 seconds after the starter and ignition button is pressed.
...
4. Engine Idle—**CHECK ENGINE INSTRUMENTS**—confirm:
    - Engine RPM is 55–60%
    - Oil pressure is 40 psi
    - Other engine instruments indicate properly
