...
3. Throttle—IDLE at 12–16% RPM. Check ignition indicator light is on, a fuel flow indication and fuel boost pump inop light out.
...
6. Idle RPM — Engine instruments checked. Engine RPM should increase steadily, with the throttle at IDLE, to 55–60%, and oil pressure should increase steadily to a minimum of 40 psi; then check all engine instruments for proper indication.

!!! caution
    If the ignition-on light fails to extinguish after idle RPM is obtained, the starter centrifugal cutout switch has failed and the starter and ignition STOP button must be pressed momentarily to shut down the starter and de-energize the ignition circuit.
...
2. Throttle — IDLE at 2–4% RPM. Check
ignition indicator light-on, a fuel flow indication and fuel boost pump inop light-out.
...
!!! caution
    If engine fails to accelerate to 55–60% (idle) RPM within 1 minute after light-up, or if exhaust temperature exceeds start limits, return throttle to OFF and allow engine to unwind; then press starter and ignition STOP button to abort start. Except for exhaust overtemperature, another start may be attempted.
...
55–60%, and oil pressure should increase steadily to
