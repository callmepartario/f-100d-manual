...
!!! note
    If a flame-out occurs under these conditions, attempt an [air start](../Emergency/air-start.md) if remaining altitude and fuel permit.
...
2. AC Generator Switch—**RESET** momentarily, then **ON**
