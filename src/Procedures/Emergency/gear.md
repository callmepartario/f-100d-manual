...
1. Airspeed—230-180 KIAS. Reduce airspeed to 230-180 KIAS. Otherwise, air loads may hold gear doors closed. Below 180 KIAS, gear might not lock down.
2. Landing gear handle—**DOWN**.
3. Landing gear emergency handle—**PULL**.
4. Landing gear position indicator—**CHECK SAFE**. The red warning light in the landing gear control handle should extinguish when the gear is down and locked, and landing gear position indicators should show safe indication. If these conditions are not present, proceed to step 5.
...
8. Nose wheel steering—**ENGAGE**. Engage nose wheel steering if nose gear is extended.
